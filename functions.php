<?php
/**
 * YWR_2020 functions and definitions*
 *
 * @package WordPress
 * @subpackage YWR_2020
 * @since YWR_2020 1.0
...
/**
 * YWR_2020 only works in WordPress 4.4 or later.
 */
if (version_compare($GLOBALS['wp_version'], '4.4-alpha', '<')) {
    require get_template_directory() . '/inc/back-compat.php';
}
if (!function_exists('YWR_2020_setup')):
/**
 ...
 *
 * Create your own YWR_2020_setup() function to override in a child theme.
 *
 */
    function YWR_2020_setup()
{
        /*
         * Make theme available for translation.
         * Translations can be filed in the /languages/ directory.
         * If you're building a theme based on Twenty Sixteen, use a find and replace
         * to change 'YWR_2020' to the name of your theme in all the template files
         */
        load_theme_textdomain('YWR_2020', get_template_directory() . '/languages');
        ...
        function custom_image_sizes_choose($sizes)
    {
        ...
        register_nav_menus(array(
            'primary' => __('Primary Menu', 'YWR_2020'),
            'footer1' => __('Footer Right'),
            'footer2' => __('Footer Menu'),
        ));
...
endif; // YWR_2020_setup
add_action('after_setup_theme', 'YWR_2020_setup');
...
add_action('widgets_init', 'YWR_2020_widgets_init');

/******************************
 * Enqueues scripts and styles.
 *****************************/
function YWR_2020_scripts()
{

    // Theme stylesheets.
    wp_enqueue_style('PoppinsFont', 'https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700', false, '1.0', 'all');
    ...
    wp_enqueue_style('IONICONS', get_template_directory_uri() . '/vendor/ionicons/css/ionicons.min.css', false, '1.0', 'all');
    wp_enqueue_style('ANIMATE', get_template_directory_uri() . '/vendor/animate.css/animate.min.css', false, '1.0', 'all');
    wp_enqueue_style('FontAwesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css', false, '1.0', 'all');
    wp_enqueue_style('OwlCarousel', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css', false, '1.0', 'all');
    ...
    wp_enqueue_script('BootstrapJs', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.5.3/js/bootstrap.bundle.min.js', array('jquery'), 1.0, true);
    wp_enqueue_script('jqueryEasing', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.min.js', array('jquery'), 1.0, true);
    wp_enqueue_script('OwlCarouselJs', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.js', array('jquery'), 1.0, true);
    wp_enqueue_script('ScrollReveal', 'https://cdnjs.cloudflare.com/ajax/libs/scrollReveal.js/4.0.7/scrollreveal.min.js', array('jquery'), 1.0, true);
    wp_enqueue_script('ThemeJs', get_template_directory_uri() . '/vendor/main.js', array('jquery'), 1.0, true);
...
add_action('wp_enqueue_scripts', 'YWR_2020_scripts');
 ...
 *****************************************************/
function YWR_2020_filter_wp_mail_from($email)
{
...
add_filter("wp_mail_from", "YWR_2020_filter_wp_mail_from");

/* enter the full name you want displayed alongside the email address */
function YWR_2020_filter_wp_mail_from_name($from_name)
{
    return "YWR_2020";
}
//add_filter("wp_mail_from_name", "YWR_2020_filter_wp_mail_from_name");
...
//$YWR_2020_User_Caps = new YWR_2020_User_Caps();

// Hide all administrators from user list.

//add_action('pre_user_query','YWR_2020_pre_user_query');
function YWR_2020_pre_user_query($user_search)
{
